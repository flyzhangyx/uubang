...
<head>
	...
	<script type="text/javascript">
		function checkdata()
		{
			if (document.add.name.value.length!=0&&document.add.attribute.value.length!=0&&document.add.describes.value.length!=0&&document.add.findaddress.value.length!=0&&document.add.phone.value.length!=0&&document.add.photo_data.value.length!=0)
			{
